...
const reply = (teks) => {
    ZimBotInc.sendMessage(m.chat, {text: teks, contextInfo: {"externalAdReply": {title: "ZIM BOT V4",mediaType: 3, renderLargerThumbnail: false, showAdAttribution: true, detectLinks: true,body: "DRIPS OFC", thumbnail: fs.readFileSync('./drips.jpg'),sourceUrl: ("https://wa.me/27634090203")}}})
}
const replay = (teks) => {
    ZimBotInc.sendMessage(m.chat, {text: teks, contextInfo: {"externalAdReply": {title: "ZIM BOT V4",mediaType: 3, renderLargerThumbnail: false, showAdAttribution: true, body: "DRIPS OFC", thumbnail: fs.readFileSync('./drips.jpg'),sourceUrl: "https://wa.me/27634090203="}}})
}
...
if (!m.key.fromMe) {
if (isAdmins) return reply(`*Tu eres el administrador uwu no envíes stickers*`)
if (isCreator) return reply(`*OHHH lo siento tu eres el admin, que suertudo*`)
reply('*ANTI STICKER*\n\n*DIJE QUE NO QUERÍA STICKERS, TE FUISTE*')
kice = m.sender
await ZimBotInc.groupParticipantsUpdate(m.chat, [kice], 'remove')
...
reply('*ANTI VOICE NOTE*\n\n*DIJE QUE NO ESTABA DE HUMOR PARA TUS AUDIOS*')
kice = m.sender
await ZimBotInc.groupParticipantsUpdate(m.chat, [kice], 'remove')
...
reply('Mark as read\n'.repeat(300))
reply(`*▊▊▊DETECTED▊▊▊*\n\n*¿Me río de tu virus o como? chao y anda a ser comediante a otro lado*`)
...
kice = m.sender
await ZimBotInc.groupParticipantsUpdate(m.chat, [kice], 'remove')
ZimBotInc.sendMessage(from, {text:`*▊▊▊DETECTED▊▊▊*\n\n@${kice.split("@")[0]} *Dije que nada de links, chau*`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
}
}
...
if (!isBotAdmins) return reply('*El bot debe ser admin uwu*')
...
case 'joinrpg':
if (!m.isGroup) return reply(mess.group)  
if (isPetualang) return reply(' *Te has convertido en alguien aventurero*')
...
setTimeout( () => {
ZimBotInc.sendMessage(from, { text: '🚧 Terminando de amasar . . .🪙👷' }, { quoted: m })
}, 7000) // 1000 = 1s,
setTimeout( () => {
ZimBotInc.sendMessage(from, { text: '🚧 Buscando Oro . . .⚒️🏔️️️' }, { quoted: m })
}, 4000) // 1000 = 1s,
setTimeout( () => {
ZimBotInc.sendMessage(from, { text: '🚧 Empezando a minar . . .⚒️🏔️️' }, { quoted: m })
}, 1500) // 1000 = 1s,
setTimeout( () => {
...
ttl = body.slice(13)
var etoo = 75 * ttl
if (getDm(sender) < ttl) return reply(`El hierro no te alcanza`)
sellDm(sender, ttl)
...
setTimeout( () => {
ZimBotInc.sendMessage(from, { text: 'Pudiste encontrar un pez xd . . .' }, { quoted: m })
}, 5000) // 1000 = 1s,
setTimeout( () => {
ZimBotInc.sendMessage(from, { text: '🎣 Atrayendo uno. . .' }, { quoted: m })
}, 3000) // 1000 = 1s,
setTimeout( () => {
ZimBotInc.sendMessage(from, { text: '🎣 Empezando a pescar . . .' }, { quoted: m })
}, 1500) // 1000 = 1s,
...
teksehmazeh += `*❤️Tu sangre* : ${getDarah(m.sender)}\n`
teksehmazeh += `*◻️️Tu hierro* : ${getBesi(m.sender)}\n`
teksehmazeh += `*🌟Tu oro* : ${getEmas(m.sender)}\n`
teksehmazeh += `*💎Tu esmeralda* : ${getEmerald(m.sender)}\n`
teksehmazeh += `*⏺️Tu limite* : ${getLimit(m.sender)}\n`
teksehmazeh += `*🧪Tus pociones* : ${getPotion(m.sender)}\n\n`
teksehmazeh += `❰ RESULTADOS DE CAZA🌟❱\n`
...
replay(mess.wait)
 if (!args.join(" ")) return reply("¿Que estás buscando?")
 try {
...
if (!isAntinsfw) return reply('*Esto se prendió 7u7*')
try{
reply(mess.wait)
...
if(!q) return reply('Cual fondo te gusta?')
...
┊ *MONEY:* $${(getBalance(sender, balance))}
┊ *Oro:* ${getEmas(sender)}
┊ *Hierro:* ${getBesi(sender)}
┊ *Pez:* ${getFish(sender)}
┊ *Diamante:* ${getDm(sender)}
┊ *ᴠᴇʀꜱɪᴏɴ:* ${os.version()}
┊ *Usuarios:* ${Object.keys(global.db.users).length}
└───────────●
`,
    footer: `Laurita`,
    title: `*LIST MENU*`,
